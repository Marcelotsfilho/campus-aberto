<template>
    <header class="flex flex-row items-center justify-between bg-white p-4 pr-32 w-full">
        <nuxt-link to="/">
            <img src="/assets/images/logoC.A-azul.png" alt="Logo" class="h-10 w-auto pl-10" />
        </nuxt-link>
